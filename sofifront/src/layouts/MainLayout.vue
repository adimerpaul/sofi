...
export default {
  data() {
    return {
      ...
      cobrador: ['4035534'],
      despachador: ['7205489', 'A1SUD', 'A2NORTE', 'A3CENTRO', 'A4BOLIVAR', 'A5APOYO', 'C1RECOGE', 'B3LLALLAGUA','B4CARACOLLO', '7277481', 'B1HUANUNI', 'MOTO1', 'MOTO2', 'B2CHALLAPATA'],
  ...
  methods: {
    irformulario() {
      var win = window.open('https://form.jotform.com/252126456052653', '_blank');
